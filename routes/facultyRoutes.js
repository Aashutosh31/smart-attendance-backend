...
const { getAssignedCourses, recognizeStudentFace, saveAttendance, getTodayLectures, startLecture, endLecture, getDashboardStats } = require('../controllers/facultyController');
